...
Added PhonePe payments because UPI is huge in India, Cloudinary for image handling, OSM for maps (google maps api is expensive af), and later integrated AI for crop disease detection using image analysis.
...
- **Multi-language:** English, Hindi, Punjabi, Telugu — because language shouldnt be a barrier
...
<p align="center">
  <img src="./app/release/screenshot1.jpg" width="200" alt="Screenshot 1">
