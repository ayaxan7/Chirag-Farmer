...
fun AppNavigation(
    ...
    NavHost(
        ...
        composable(
            Route.OTPVerification.path, arguments = listOf(
            navArgument("phone") { type = NavType.StringType })) { backStackEntry ->
            val phoneNumber = backStackEntry.arguments?.getString("phone") ?: ""
            OTPVerificationScreen(
                navController = navController, phoneNumber = phoneNumber, modifier = modifier
            )
        }
    }
}
